...
function Adult() {
  ...
  return (
    ...
    >
        ...
        >
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
            ...
            >
              ...
              <motion.p 
                className="text-lg sm:text-xl lg:text-2xl text-gray- mb-8"
                variants={fadeInUp}
              >
      ...
      <ScrollAnimationWrapper>
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              <motion.p 
                className="text-teal-600 font-medium text-xl mb-4"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
              >
      ...
      <motion.div
        // className="fixed bottom-10 right-10 bg-[#FFCB45] text-white p-4 rounded-full shadow-lg"
        style={{ opacity, scale }}
      >
