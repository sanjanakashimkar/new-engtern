...
function Adult() {
  ...
  const whatsappMessage = encodeURIComponent("Hi, I want to know more about Engtern for Adults!")
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-8">
          ...
          <motion.div className="flex-1 max-w-2xl" variants={fadeInUp}>
            ...
            <motion.p className="text-gray-700 mb-4" variants={fadeInUp}>
              In this fast-moving world, none of us would want to have slow speaking or less engagement. Networking has
              become the need of the hour, which requires professional communication skills.
            </motion.p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <motion.p className="text-gray-700 leading-relaxed text-center" variants={fadeInUp}>
              And for all this, we are here to give you the best of all the world in your live sessions, valuing your
              time and efforts.{" "}
              <motion.span
          ...
          >
            <div className="aspect-w-16 aspect-h-9 rounded-lg shadow-lg overflow-hidden">
              <video className="w-full h-full object-cover" autoPlay loop muted src={adult}>
